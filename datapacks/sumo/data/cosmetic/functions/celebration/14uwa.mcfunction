...
execute as @a[tag=!winner,tag=playing] at @s if score $end cooldown matches 99 run replaceitem entity @s armor.head carved_pumpkin
...
execute as @a[tag=!winner,tag=playing] at @s if score $end cooldown matches 1 run replaceitem entity @s armor.head air