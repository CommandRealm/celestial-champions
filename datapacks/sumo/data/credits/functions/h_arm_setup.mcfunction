...
replaceitem entity @e[tag=hippeh] armor.feet leather_boots{display:{color:5789784}}
replaceitem entity @e[tag=hippeh] armor.chest leather_chestplate{display:{color:10039096}}
replaceitem entity @e[tag=hippeh] armor.legs leather_leggings{display:{color:2316835}}