...
replaceitem entity @e[tag=regsbody] armor.feet leather_boots{display:{color:16711701}}
replaceitem entity @e[tag=regsbody] armor.chest leather_chestplate{display:{color:16711701}}
replaceitem entity @e[tag=regsbody] armor.legs leather_leggings{display:{color:15592941}}