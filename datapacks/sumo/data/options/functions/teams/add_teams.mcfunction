...
execute if score $teams settings matches 1 run setblock -7 64 22 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"Number of","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"teams:","color":"aqua","bold":true}', '{"text":"Solos","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:teams/check_click_teams"}}'], has_glowing_text: false, color: "black"}}
execute if score $teams settings matches 2.. run setblock -7 64 22 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"Number of","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"teams:","color":"aqua","bold":true}', '{"score":{"objective":"settings","name":"$teams"},"color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:teams/check_click_teams"}}'], has_glowing_text: false, color: "black"}}
