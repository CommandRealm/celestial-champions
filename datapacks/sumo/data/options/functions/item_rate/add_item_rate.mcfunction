...
execute if score $item_rate settings matches 0 run setblock -7 64 24 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Item","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"spawn rate:","color":"aqua","bold":true}', '{"translate":"Off","color":"gold"}', '{"translate":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:item_rate/check_click_item_rate"}}'], has_glowing_text: false, color: "black"}}
execute if score $item_rate settings matches 1 run setblock -7 64 24 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Item","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"spawn rate:","color":"aqua","bold":true}', '{"translate":"Fast","color":"gold"}', '{"translate":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:item_rate/check_click_item_rate"}}'], has_glowing_text: false, color: "black"}}
execute if score $item_rate settings matches 2 run setblock -7 64 24 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Item","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"spawn rate:","color":"aqua","bold":true}', '{"translate":"Normal","color":"gold"}', '{"translate":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:item_rate/check_click_item_rate"}}'], has_glowing_text: false, color: "black"}}
execute if score $item_rate settings matches 3 run setblock -7 64 24 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Item","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"spawn rate:","color":"aqua","bold":true}', '{"translate":"Slow","color":"gold"}', '{"translate":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:item_rate/check_click_item_rate"}}'], has_glowing_text: false, color: "black"}}
