...
execute if score $time_of_day settings matches 0 run setblock -7 64 26 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Time of day:","color":"aqua","bold":true}', '{"text":"Random","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/check_click_time_of_day"}}'], has_glowing_text: false, color: "black"}}
execute if score $time_of_day settings matches 1 run setblock -7 64 26 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Time of day:","color":"aqua","bold":true}', '{"text":"Day","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/check_click_time_of_day"}}'], has_glowing_text: false, color: "black"}}
execute if score $time_of_day settings matches 2 run setblock -7 64 26 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Time of day:","color":"aqua","bold":true}', '{"text":"Dusk","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/check_click_time_of_day"}}'], has_glowing_text: false, color: "black"}}
execute if score $time_of_day settings matches 3 run setblock -7 64 26 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Time of day:","color":"aqua","bold":true}', '{"text":"Night","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/check_click_time_of_day"}}'], has_glowing_text: false, color: "black"}}
