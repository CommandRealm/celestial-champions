...
execute if score $time_of_day settings matches 0 run setblock -7 64 26 oak_wall_sign[facing=east]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Time of day:","color":"aqua","bold":true}',Text3:'{"text":"Random","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/click_time_of_day"}}'}
execute if score $time_of_day settings matches 1 run setblock -7 64 26 oak_wall_sign[facing=east]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Time of day:","color":"aqua","bold":true}',Text3:'{"text":"Day","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/click_time_of_day"}}'}
execute if score $time_of_day settings matches 2 run setblock -7 64 26 oak_wall_sign[facing=east]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Time of day:","color":"aqua","bold":true}',Text3:'{"text":"Dusk","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/click_time_of_day"}}'}
execute if score $time_of_day settings matches 3 run setblock -7 64 26 oak_wall_sign[facing=east]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Time of day:","color":"aqua","bold":true}',Text3:'{"text":"Night","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:time_of_day/click_time_of_day"}}'}
