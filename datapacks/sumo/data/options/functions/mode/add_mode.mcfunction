...
execute if score $mode settings matches 4.. run scoreboard players set $mode settings 0
execute if score $mode settings matches ..-1 run scoreboard players set $mode settings 3

execute if score $mode settings matches 0 run setblock 7 64 20 oak_wall_sign[facing=west]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Mode:","color":"aqua","bold":true}',Text3:'{"text":"Lives","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
execute if score $mode settings matches 1 run setblock 7 64 20 oak_wall_sign[facing=west]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Mode:","color":"aqua","bold":true}',Text3:'{"text":"Kills","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
execute if score $mode settings matches 2 run setblock 7 64 20 oak_wall_sign[facing=west]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Mode:","color":"aqua","bold":true}',Text3:'{"text":"Time","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
execute if score $mode settings matches 3 run setblock 7 64 20 oak_wall_sign[facing=west]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Mode:","color":"aqua","bold":true}',Text3:'{"text":"Duels","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
...
execute if score $mode settings matches 3 run summon armor_stand 8 63.825 20 {DisabledSlots:2039583,Tags:["display_mode","model"],Small:0b,Invisible:1b,NoGravity:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:gray_terracotta",Count:1b}]}
...
execute if score $mode settings matches 3 run fill 8 66 24 8 63 24 air

execute if score $mode settings matches 3 run fill 8 66 22 8 63 22 air
...
execute if score $mode settings matches 3 run scoreboard players set $teams settings 0
execute if score $mode settings matches 3 run function options:teams/add_teams

execute unless score $mode settings matches 3 run scoreboard players remove $map settings 1
execute unless score $mode settings matches 3 run function options:map/add_map