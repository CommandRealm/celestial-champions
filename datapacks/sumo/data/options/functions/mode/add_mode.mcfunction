...
execute if score $mode settings matches 0 run setblock 7 64 20 oak_wall_sign[facing=west]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Mode:","color":"aqua","bold":true}', '{"text":"Lives","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'], has_glowing_text: false, color: "black"}}
execute if score $mode settings matches 1 run setblock 7 64 20 oak_wall_sign[facing=west]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Mode:","color":"aqua","bold":true}', '{"text":"Kills","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'], has_glowing_text: false, color: "black"}}
execute if score $mode settings matches 2 run setblock 7 64 20 oak_wall_sign[facing=west]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Mode:","color":"aqua","bold":true}', '{"text":"Time","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'], has_glowing_text: false, color: "black"}}
execute if score $mode settings matches 3 run setblock 7 64 20 oak_wall_sign[facing=west]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Mode:","color":"aqua","bold":true}', '{"text":"Duels","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'], has_glowing_text: false, color: "black"}}
execute if score $mode settings matches 4 run setblock 7 64 20 oak_wall_sign[facing=west]{front_text:{messages:['{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Mode:","color":"aqua","bold":true}', '{"text":"Competitive","color":"gold"}', '{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'], has_glowing_text: false, color: "black"}}
