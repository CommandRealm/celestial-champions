...
execute if score $auto_ready settings matches 0 run setblock -7 64 22 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Auto-ready","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"after games:","color":"aqua","bold":true}', '{"translate":"Off","color":"gold"}', '{"translate":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:auto_ready/click_auto_ready"}}'], has_glowing_text: false, color: "black"}}
execute if score $auto_ready settings matches 1 run setblock -7 64 22 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Auto-ready","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"after games:","color":"aqua","bold":true}', '{"translate":"On","color":"gold"}', '{"translate":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:auto_ready/click_auto_ready"}}'], has_glowing_text: false, color: "black"}}
