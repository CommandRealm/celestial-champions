...
execute if score $auto_ready settings matches 0 run setblock -7 64 22 oak_wall_sign[facing=east]{Text1:'{"text":"Auto-ready","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"after games:","color":"aqua","bold":true}',Text3:'{"text":"Off","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:auto_ready/click_auto_ready"}}'}
execute if score $auto_ready settings matches 1 run setblock -7 64 22 oak_wall_sign[facing=east]{Text1:'{"text":"Auto-ready","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"after games:","color":"aqua","bold":true}',Text3:'{"text":"On","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:auto_ready/click_auto_ready"}}'}
