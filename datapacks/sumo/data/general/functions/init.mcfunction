...
team modify sr_artist color aqua
...
team modify sr_artist prefix {"text":"{Sr. Artist} ","color":"dark_green"}
...
scoreboard objectives add damage_percent dummy [{"text":"%","color":"white"}]
