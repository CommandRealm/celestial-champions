...
scoreboard players set @s f_16_costume 0
scoreboard players set @s f_17_costume 0
...
scoreboard players set @s queued_track 25
...
tag @s remove unlock_guardian_2
tag @s remove unlock_guardian_3

tag @s remove unlock_arthor_2
