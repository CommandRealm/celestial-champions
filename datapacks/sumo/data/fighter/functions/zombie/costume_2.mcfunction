...
item replace entity @s armor.head with mossy_cobblestone{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Zombie Villager\'s Head","italic":false,"color":"dark_green","bold":true}]'},costume:1b,CustomModelData:1}
