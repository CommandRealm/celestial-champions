...
##Tellraw
tellraw @s[tag=!no_ability_msg] [{"translate":"--------------------------","color":"aqua"},{"translate":"\nGround Ability: ","color":"gray","bold":true},{"translate":"Dragon's Breath\n","color":"white"},{"translate":"(Hover for description.)\n","color":"#bd9b4b","italic":true,"hoverEvent":{"action":"show_text","value":{"translate":"Dragon's breath AOE damages opponents in it while raising your combo, lasts 5 seconds."}}},{"translate":"--------------------------","color":"aqua"}]
