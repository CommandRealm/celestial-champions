...
item replace entity @s armor.head with dragon_egg{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Drakier\'s Head","italic":false,"color":"#e09400","bold":true}]'},costume:1b,CustomModelData:9}
item replace entity @s armor.chest with elytra{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Drakier\'s Elytra","italic":false,"color":"#e09400","bold":true}]',color:14717952},costume:1b}
