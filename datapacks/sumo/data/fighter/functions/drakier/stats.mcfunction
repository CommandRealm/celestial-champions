##set's drakier's stats.


##Combo multipliers are divided by 100
scoreboard players set @s combo_multiplier 49
...
scoreboard players set @s set_e_jump_time 12

##Levitation amplifier for extra jumps
scoreboard players set @s extra_jump_force 15

##Jump boost amplifier
scoreboard players set @s jump_force -1

##Arrow timer
scoreboard players set @s set_arrow_timer 120