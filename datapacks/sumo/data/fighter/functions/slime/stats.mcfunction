...
scoreboard players set @s combo_multiplier 35
...
##Best knockback
scoreboard players set @s max_knockback 7
...
scoreboard players set @s set_e_jump_time 9

##Levitation amplifier for extra jumps
scoreboard players set @s extra_jump_force 17

##Jump boost amplifier
scoreboard players set @s jump_force 4