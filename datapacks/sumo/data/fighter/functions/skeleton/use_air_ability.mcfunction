...
execute if entity @s[scores={costume=1}] run item replace entity @e[type=skeleton,tag=needs_motion,sort=nearest,limit=1] armor.chest with leather_chestplate{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Stray\'s Torso","italic":false,"color":"#88b9b3","bold":true}]',color:7188145},costume:1b}


execute if entity @s[scores={costume=2}] run item replace entity @e[type=skeleton,tag=needs_motion,sort=nearest,limit=1] armor.head with player_head{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Wither Skeleton\'s Head","italic":false,"color":"#4e4e4e","bold":true}]'},costume:1b,SkullOwner:{Id:[I;74542885,33506059,-2081859536,-268206202],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDc2MzM4ZTRjYTYwYjgzYTllOGFjZmJhM2E3OTkyZmIyZDkzY2RkNWFmNzg1Mjc2NWYyNTU3MmEwNjc0ZjM1MyJ9fX0="}]}}}
execute if entity @s[scores={costume=2}] run item replace entity @e[type=skeleton,tag=needs_motion,sort=nearest,limit=1] armor.chest with diamond_chestplate{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Wither Skeleton\'s Torso","italic":false,"color":"#4e4e4e","bold":true}]'},costume:1b}
execute if entity @s[scores={costume=2}] run item replace entity @e[type=skeleton,tag=needs_motion,sort=nearest,limit=1] armor.legs with diamond_leggings{AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.0175,UUID:[I; 50, 50, 50, 50]},{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Wither Skeleton\'s Legs","italic":false,"color":"#4e4e4e","bold":true}]'},costume:1b}
execute if entity @s[scores={costume=2}] run item replace entity @e[type=skeleton,tag=needs_motion,sort=nearest,limit=1] armor.feet with leather_boots{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Wither Skeleton\'s Feet","italic":false,"color":"#4e4e4e","bold":true}]',color:4473924},costume:1b}
...
##Tellraw
tellraw @s[tag=!no_ability_msg] [{"translate":"--------------------------","color":"white"},{"translate":"\nAir Ability: ","color":"dark_aqua","bold":true},{"translate":"Bone Toss\n","color":"aqua"},{"translate":"(Hover for description.)\n","color":"#bd9b4b","italic":true,"hoverEvent":{"action":"show_text","value":{"translate":"Toss a decoy skeleton, gain slow falling and weakness and teleport to the skeleton when it lands."}}},{"translate":"--------------------------","color":"white"}]
