...
##Tellraw
tellraw @s[tag=!no_ability_msg] [{"text":"--------------------------","color":"aqua"},{"text":"\nGround Ability: ","color":"gray","bold":true},{"text":"Arrow Barrage\n","color":"white"},{"text":"(Hover for description.)\n","color":"#bd9b4b","italic":true,"hoverEvent":{"action":"show_text","value":"Fire 5 arrows in front of you."}},{"text":"--------------------------","color":"aqua"}]
...
execute positioned ^-0.5 ^ ^1 run summon arrow ~ ~ ~ {Tags:["needs_motion","additional_damage_2","skeleton_arrow"]}
execute positioned ^-0.75 ^ ^0.75 run summon arrow ~ ~ ~ {Tags:["needs_motion","additional_damage_2","skeleton_arrow"]}
execute positioned ^0.75 ^ ^0.75 run summon arrow ~ ~ ~ {Tags:["needs_motion","additional_damage_2","skeleton_arrow"]}
