...
item replace entity @s armor.head with skeleton_skull{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Skeleton\'s Head","italic":false,"color":"gray","bold":true}]'},costume:1b}
item replace entity @s armor.chest with iron_chestplate{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Skeleton\'s Torso","italic":false,"color":"gray","bold":true}]'},costume:1b}
