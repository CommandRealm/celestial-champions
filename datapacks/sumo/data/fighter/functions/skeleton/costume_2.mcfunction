...
item replace entity @s armor.chest with diamond_chestplate{CustomModelData:1,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Wither Skeleton\'s Torso","italic":false,"color":"#4e4e4e","bold":true}]'},costume:1b}
