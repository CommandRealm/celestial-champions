...
##execute if score $rand random matches 0 run summon skeleton ~ ~ ~ {Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"],ArmorItems:[{id:"minecraft:leather_boots",Count:1,tag:{display:{color:16730112}}},{id:"minecraft:leather_leggings",Count:1,tag:{display:{color:16777215}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16730112}}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;1031853657,919423726,-2059367205,1418649205],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2FmNTk3NzZmMmYwMzQxMmM3YjU5NDdhNjNhMGNmMjgzZDUxZmU2NWFjNmRmN2YyZjg4MmUwODM0NDU2NWU5In19fQ=="}]}}}}]}
execute if score $rand random matches 0..1 run summon sheep ~ ~ ~ {Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
execute if score $rand random matches 2..3 run summon cow ~ ~ ~ {Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
execute if score $rand random matches 4..5 run summon polar_bear ~ ~ ~ {Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
execute if score $rand random matches 6..7 run summon panda ~ ~ ~ {Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
execute if score $rand random matches 8..9 run summon slime ~ ~ ~ {Size:2,Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
execute if score $rand random matches 10 run summon sheep ~ ~ ~ {CustomName:'[{"text":"jeb_"}]',Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
execute if score $rand random matches 11 run summon mooshroom ~ ~ ~ {Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
execute if score $rand random matches 12 run summon panda ~ ~ ~ {MainGene:"brown",HiddenGene:"brown",Silent:1b,Invulnerable:0b,active_effects:[{id:"minecraft:weakness",amplifier:255,duration:1000,show_particles:false},{id:"minecraft:slow_falling",amplifier:255,duration:1000,show_particles:false}],Attributes:[{Name:"generic.movement_speed",Base:0},{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["only_explode_near_players","needs_copied_id","incend_ground_explosive","incend_tnt","needs_motion","on_death_timer","needs_death_timer"]}
...
##Tellraw
tellraw @s[tag=!no_ability_msg] [{"text":"--------------------------","color":"aqua"},{"text":"\nGround Ability: ","color":"gray","bold":true},{"text":"Boom Doom\n","color":"white"},{"text":"(Hover for description.)\n","color":"#bd9b4b","italic":true,"hoverEvent":{"action":"show_text","value":"Summons a random mob for 7.5 seconds that explodes near players that dropping your item again can recall."}},{"text":"--------------------------","color":"aqua"}]
