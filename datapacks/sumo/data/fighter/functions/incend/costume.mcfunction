...
item replace entity @s armor.head with player_head{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Incend\'s Head","italic":false,"color":"#802828","bold":true}]'},costume:1b,SkullOwner:{Id:[I;1736428236,-1425128944,-1611928863,226301027],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjk5ZDUxMTY2OWFjOWFhYzhhM2I0MjZlMWRiMTljMWQ5OTllMzQ2YzBiNjI2ZGFkZmE2OWNlZGM3OWQwYmUzMSJ9fX0="}]}}}
item replace entity @s armor.chest with leather_chestplate{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Incend\'s Torso","italic":false,"color":"#802828","bold":true}]',color:7546663},costume:1b}
