...
item replace entity @s armor.head with composter{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Livestock Shopkeeper\'s Head","italic":false,"color":"#8f934f","bold":true}]'},costume:1b,CustomModelData:1}
item replace entity @s armor.chest with leather_chestplate{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Livestock Shopkeeper\'s Torso","italic":false,"color":"#8f934f","bold":true}]',color:6049087},costume:1b}
