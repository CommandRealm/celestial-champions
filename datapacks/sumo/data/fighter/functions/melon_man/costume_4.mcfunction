...
item replace entity @s armor.head with oak_leaves{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Flower Shopkeeper\'s Head","italic":false,"color":"#56bf5b","bold":true}]'},costume:1b,CustomModelData:1}
item replace entity @s armor.chest with leather_chestplate{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Flower Shopkeeper\'s Torso","italic":false,"color":"#56bf5b","bold":true}]',color:7629650},costume:1b}
