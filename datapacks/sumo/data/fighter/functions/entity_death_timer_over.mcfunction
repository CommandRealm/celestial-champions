...
execute if entity @s[tag=spider_friend] run function fighter:spider/spider_friend_die
execute if entity @s[tag=spider_platform,type=shulker] run function fighter:spider/spider_platform_die
