...
##Get boots
execute as @a[tag=is_fighter,gamemode=adventure,scores={fighter=10,ability_state=1,ability_timer=1..}] at @s unless entity @s[nbt={Inventory:[{Slot:100b,id:"minecraft:iron_boots"}]}] run function fighter:callidus/get_boots
