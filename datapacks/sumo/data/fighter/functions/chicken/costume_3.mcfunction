...
item replace entity @s armor.head with player_head{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Chicken?\'s Head","italic":false,"color":"#d9d9d9","bold":true}]'},costume:1b,SkullOwner:{Id:[I;1083641894,-411744977,-1286611235,-992567531],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWRlYjAxZDBiZWVmNzJiMWVjMGFiNmU1ZmJjOTVkYTkxZWZkNTU4NWJiYmM4ZmI0YjIxZWJkYmM0MjFiMWUwIn19fQ=="}]}}}
item replace entity @s armor.chest with leather_chestplate{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Chicken?\'s Torso","italic":false,"color":"#d9d9d9","bold":true}]',color:14079702},costume:1b}
item replace entity @s armor.legs with leather_leggings{AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.0385,UUID:[I; 50, 50, 50, 50]},{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Chicken?\'s Legs","italic":false,"color":"#d9d9d9","bold":true}]',color:14079702},costume:1b}
item replace entity @s[tag=!slow_falling_until_landing] armor.feet with leather_boots{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,UUID:[I; 999, 999, 999]}],Unbreakable:1b,HideFlags:63,display:{Name:'[{"translate":"Chicken?\'s Feet","italic":false,"color":"#d9d9d9","bold":true}]',color:16767584},costume:1b}
