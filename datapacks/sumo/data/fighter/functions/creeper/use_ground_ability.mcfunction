...
execute positioned ^ ^ ^1 if entity @s[scores={costume=1}] run summon zombie ~ ~2 ~ {Silent:1b,Invulnerable:1b,Tags:["needs_motion","needs_copied_id","on_death_timer","needs_death_timer","creeper_grenade"],ArmorItems:[{},{},{},{id:"minecraft:tnt",Count:1b,tag:{CustomModelData:2}}],active_effects:[{id:"minecraft:invisibility",amplifier:254,duration:1000,show_particles:false},{id:"minecraft:resistance",amplifier:254,duration:1000,show_particles:false}],Attributes:[{Name:"generic.follow_range",Base:0}]}
execute positioned ^ ^ ^1 if entity @s[scores={costume=2}] run summon zombie ~ ~2 ~ {Silent:1b,Invulnerable:1b,Tags:["needs_motion","needs_copied_id","on_death_timer","needs_death_timer","creeper_grenade"],ArmorItems:[{},{},{},{id:"minecraft:tnt",Count:1b,tag:{CustomModelData:3}}],active_effects:[{id:"minecraft:invisibility",amplifier:254,duration:1000,show_particles:false},{id:"minecraft:resistance",amplifier:254,duration:1000,show_particles:false}],Attributes:[{Name:"generic.follow_range",Base:0}]}
