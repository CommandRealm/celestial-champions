...
execute if entity @s[scores={music_track=1}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Anthem of the Frogs","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=2}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Away from the Madness","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=3}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Beyond the Fear","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=4}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"BlockMan","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=5}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Buckle Up!","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Vexento","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=6}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Cut and Run","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=7}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Danger Storm","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=8}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Dark Versus Light","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=9}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Edm Detection Mode","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=10}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Exit the Premises","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=11}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Hiding Your Reality","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=12}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Into the Abyss","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=13}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Lost in the Groove","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=14}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Mechanical Dusk","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=15}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"New Groove","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=16}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Sax, Rock, and Roll","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=17}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Son of a Rocket","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=18}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Special Spotlight","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=19}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"The Next Sunset","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=20}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Underwater Lifecycle","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=21}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Voices of Reason","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=22}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Voltaic","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=23}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Waves in the Sky","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"TeknoAXE","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=24}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Werq","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
...
execute if entity @s[scores={music_track=25}] run tellraw @s[tag=!no_music_msg] [{"text":"Music: ","color":"gold","bold":true},{"text":"Mistake the Getaway","color":"aqua","bold":false},{"text":" - ","color":"gray"},{"text":"Kevin MacLeod","color":"white","bold":false}]
