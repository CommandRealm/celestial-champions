...
replaceitem entity @s inventory.15 red_stained_glass_pane{not_clickable:1,previous_button:1b,display:{Name:'[{"text":"Previous","color":"red","bold":true,"italic":false}]',Lore:['[{"text":"Press to play","color":"gray","italic":false}]','[{"text":"the previous track.","color":"gray","italic":false}]']}}
