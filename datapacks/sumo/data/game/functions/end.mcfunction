...
##Ready scores
execute if score $auto_ready settings matches 0 run scoreboard players set @a[tag=playing] ready 0
execute if score $auto_ready settings matches 1 run scoreboard players set @a[tag=playing] ready 1
