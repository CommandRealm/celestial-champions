...
execute if score $time game matches 1 run function game:rounds/start_round
...
##Cooldown
execute if score $time cooldown matches 1.. run function game:rounds/cooldown
...
execute unless score $time cooldown matches 0.. if score $alive criteria matches ..1 run function game:rounds/check_round_winner