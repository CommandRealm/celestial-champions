...
execute if score $time game matches 1 run function game:kills_timer/start_game
...
##Cooldown
execute if score $time cooldown matches 1.. run function game:kills_timer/cooldown
...
##End function
execute if score $time criteria matches 0 run function game:kills_timer/timer_over