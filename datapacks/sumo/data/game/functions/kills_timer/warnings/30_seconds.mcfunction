##30 second warning timer.

##Tellraw
tellraw @a[tag=playing] [{"translate":"☀","bold":false,"color":"white"},{"translate":":","color":"gray"},{"translate":" 30 seconds remaining!","color":"aqua","bold":false}]
