...
execute if score $time game matches 1 run function game:kills_criteria/start_game
...
##Cooldown
execute if score $time cooldown matches 1.. run function game:kills_criteria/cooldown