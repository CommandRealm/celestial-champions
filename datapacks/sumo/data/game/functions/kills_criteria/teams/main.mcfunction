##Main function for teams kill criteria mode.
...
execute if score $time game matches 1 run function game:kills_criteria/teams/start_game
...
##Cooldown
execute if score $time cooldown matches 1.. run function game:kills_criteria/teams/cooldown