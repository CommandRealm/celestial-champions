...
tellraw @a[tag=playing] [{"selector":"@p[tag=playing,tag=!just_striked]"},{"translate":" has chosen to strike ","color":"gray"},{"translate":"Elsewhere","color":"dark_purple"},{"translate":"!","color":"gray"}]
