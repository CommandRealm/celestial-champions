...
setblock 6 61 88 air destroy
setblock 6 61 88 structure_void
execute positioned 6 61 88 as @e[type=area_effect_cloud,tag=competitive_nameplate,sort=nearest,limit=1] at @s run function game:competitive/striking_phase/strikethrough_name

tellraw @a[tag=playing] [{"selector":"@p[tag=playing,tag=!just_striked]"},{"translate":" has chosen to strike ","color":"gray"},{"translate":"Deforested","color":"green"},{"translate":"!","color":"gray"}]
