...
tellraw @a[tag=playing] [{"selector":"@p[tag=playing,tag=!just_striked]"},{"translate":" has chosen to strike ","color":"gray"},{"translate":"Hovercraft","color":"dark_green"},{"translate":"!","color":"gray"}]
