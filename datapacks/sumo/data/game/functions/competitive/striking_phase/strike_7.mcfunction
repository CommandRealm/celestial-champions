...
tellraw @a[tag=playing] [{"selector":"@p[tag=playing,tag=!just_striked]"},{"translate":" has chosen to strike ","color":"gray"},{"translate":"Rainbow","color":"gold"},{"translate":"!","color":"gray"}]
