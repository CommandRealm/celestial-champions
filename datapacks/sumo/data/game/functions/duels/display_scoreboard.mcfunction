...
execute as @a[scores={fake_criteria=0},tag=playing] run tellraw @a [{"text":"Winner: ","color":"white"},{"selector":"@s"},{"text":" score: ","color":"aqua"},{"score":{"objective":"criteria","name":"@s"},"color":"aqua"}]
