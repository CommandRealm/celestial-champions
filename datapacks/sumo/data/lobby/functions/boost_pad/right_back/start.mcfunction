...
##Summon armor stand
summon minecraft:armor_stand ~ ~ ~ {Tags:["boost_pad_force_spectate","needs_adjustments"],Rotation:[-90f,25f],Invulnerable:1b,DisabledSlots:2039583,Invisible:0b,NoBasePlate:1b,OnGround:0b,ShowArms:1b,CustomNameVisible:1b}
