...
##Summon armor stand
summon minecraft:armor_stand ~ ~ ~ {Tags:["boost_pad_force_spectate","needs_adjustments"],Rotation:[180f,25f],Invulnerable:1b,DisabledSlots:2039583,Invisible:0b,NoBasePlate:1b,OnGround:0b,ShowArms:1b,CustomNameVisible:1b}
...
execute as @e[type=armor_stand,tag=needs_adjustments,sort=nearest,limit=1] at @s run data merge entity @s {Motion:[0.0d,2.25d,-2.75d],OnGround:0b}
