...
execute if score $ready_players pregame matches 50.. run function lobby:pregame/countdown_end
execute if score $mode settings matches 4 if score $ready_players pregame matches 3.. run function lobby:pregame/countdown_end
