...
item replace entity @s[scores={ready=1}] hotbar.5 with knowledge_book{CustomModelData:1,not_clickable:1,Recipes:[],display:{Name:'[{"text":"Click","color":"gray","bold":true,"italic":false},{"text":" to unready.","color":"dark_gray","bold":false}]'},Enchantments:[{id:"x",lvl:1}]}