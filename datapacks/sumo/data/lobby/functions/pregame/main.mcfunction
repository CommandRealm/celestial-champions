...
##Actionbar titles
title @a[x=0,y=66,z=0,distance=..500,gamemode=adventure,scores={ready=0},tag=!is_fighter] actionbar [{"translate":"You will ","color":"gray"},{"translate":"not play.","color":"dark_gray"},{"translate":" (","color":"white","bold":true},{"score":{"objective":"pregame","name":"$ready_players"},"color":"aqua","bold":false},{"translate":"/","color":"white","bold":false},{"score":{"objective":"pregame","name":"$players_on"},"color":"aqua","bold":false},{"translate":")","color":"white","bold":true}]
title @a[x=0,y=66,z=0,distance=..500,gamemode=adventure,scores={ready=1},tag=!is_fighter] actionbar [{"translate":"You will ","color":"white"},{"translate":"play.","color":"aqua"},{"translate":" (","color":"white","bold":true},{"score":{"objective":"pregame","name":"$ready_players"},"color":"aqua","bold":false},{"translate":"/","color":"white","bold":false},{"score":{"objective":"pregame","name":"$players_on"},"color":"aqua","bold":false},{"translate":")","color":"white","bold":true}]
