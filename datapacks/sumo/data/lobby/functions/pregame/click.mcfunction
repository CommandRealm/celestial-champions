...
playsound minecraft:entity.firework_rocket.launch master @s ~ ~ ~ 10000 1.75
playsound minecraft:entity.firework_rocket.launch master @s ~ ~ ~ 10000 1.5
playsound minecraft:entity.firework_rocket.launch master @s ~ ~ ~ 10000 1.25