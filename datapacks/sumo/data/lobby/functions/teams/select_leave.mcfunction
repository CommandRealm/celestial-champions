...
execute unless entity @s[team=!lobby,team=!test,team=!help,team=!bld,team=!prg,team=!srprg,team=!lead,team=!sky_explorer,team=!sr_art,team=!pc_role,team=!manager] run tellraw @s {"text":"You are not on a team.","color":"gray"}
