...
tellraw @s {"translate":"Zombie","bold":true,"color":"#71955b"}
...
##Ground ability
tellraw @s [{"translate":""},{"translate":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while on the ground."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Grave Danger ","color":"aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Summons a grave in front of yourself, launching opponents into the air, removing one ","color":"white"},{"translate":"extra jump","bold":true,"color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"Jumps that are only usable in the air, reset when grounded, and cannot be removed by an ability if you only have 1."}}},{"translate":".","color":"white"}]
...
##Air ability
tellraw @s [{"translate":""},{"translate":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while in the air."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Fortify ","color":"dark_aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Gives ","color":"white"},{"translate":"invincibility","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"translate":"Immune to knockback."}}},{"translate":" for 2 seconds.","color":"white"}]
