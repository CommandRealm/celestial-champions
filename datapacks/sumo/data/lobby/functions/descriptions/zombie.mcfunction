...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Fortify ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Gives ","color":"white"},{"text":"invincibility","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Immune to knockback."}},{"text":" for 2 seconds.","color":"white"}]
