##Called to give the description of Callidus
...
tellraw @s {"text":"Callidus","bold":true,"color":"#d1ae5c"}

##Called to give us Callidus's stats
scoreboard players operation @s calculate = @s fighter
scoreboard players set @s fighter 10
...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"Throwing your trident and hitting a player gives ","color":"white","bold":false},{"text":"max knockback","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Full combo meter."}},{"text":"; however, missing a player causes the user to lose it for 5 seconds.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Stealthy Dash ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Gives some invisibility, Speed 3, and sets knockback to 3 for 4 seconds.","color":"white"}]

##Ground ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Ground Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"20.0 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Smoke Grenade ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Throws a ","color":"white"},{"text":"blinding","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Blindness effect."}},{"text":" smoke grenade that ","color":"white"},{"text":"stuns","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Slowness and weakness."}},{"text":" opponents within a small radius for 1 second.","color":"white"}]

##Air ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Air Ability Cooldown","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Air Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"15.0 seconds","color":"white","bold":true}]
