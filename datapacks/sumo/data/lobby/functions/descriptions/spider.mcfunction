...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Web Grapple ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Fires a grappling hook laser that hooks and pulls you towards your target.","color":"white"}]
