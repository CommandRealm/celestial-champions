##Called to give the description of Spider
...
tellraw @s {"text":"Spider","bold":true,"color":"#605448"}

##Called to give us Spider's stats
scoreboard players operation @s calculate = @s fighter
scoreboard players set @s fighter 4
...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"Place one block under you whenever you ","color":"white","bold":false},{"text":"cling","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Stick to walls and slowly slide down them (during this, the player does not count as grounded.)"}},{"text":" to a wall, resets when ","color":"white"},{"text":"grounded","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Standing on a block."}},{"text":".","color":"white"}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability ","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":true},{"text":"Spider Friend ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Launches spider that attacks opponents and give yourself Speed 2 for six seconds.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Web Grapple ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Fire a laser that ","color":"white"},{"text":"stuns","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Slowness and weakness."}},{"text":" the opponent for 2 seconds and launches the user towards the opponent.","color":"white"}]
