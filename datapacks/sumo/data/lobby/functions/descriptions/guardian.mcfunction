...
tellraw @s {"text":"Guardian","bold":true,"color":"#6f9d8a"}
...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Thorn ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Shoots a laser which slows and deals damage.","color":"white"}]

##Ground ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Ground Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"3.5 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Guardian Strike ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Spawns a guardian which will shoot a damaging laser shortly; however, if the guardian is damaged, it immediately explodes.","color":"white"}]
