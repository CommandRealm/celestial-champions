...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability ","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":true},{"text":"Explosive Toss ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Throw a tiny explosive that explodes near a player or when it hits the ground.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Repellent Destruction ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Summons explosives under yourself, launching the user upward.","color":"white"}]
