##Called to give the description of Creeper
tellraw @s [{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"}]
tellraw @s {"translate":"Creeper","bold":true,"color":"#5ed04c"}

##Called to give us Creeper's stats
scoreboard players operation @s calculate = @s fighter
scoreboard players set @s fighter 3
...
##Ground ability
tellraw @s [{"translate":""},{"translate":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while on the ground."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Explosive Toss ","color":"aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Throw a tiny explosive that explodes near a player or when it hits the ground.","color":"white"}]

##Ground ability cooldown
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"How long until the fighter can use their Ground Ability again."}}},{"translate":": ","color":"gray","bold":false},{"translate":"7.0 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"translate":""},{"translate":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while in the air."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Repellent Destruction ","color":"dark_aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Summons explosives under yourself, launching the user upward.","color":"white"}]
