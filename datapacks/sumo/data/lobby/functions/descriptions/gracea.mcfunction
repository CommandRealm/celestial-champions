...
tellraw @s {"text":"Gracea","bold":true,"color":"#fadd73"}
...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Beautiful Barricade ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Places an impenetrable wall that lasts 4 seconds.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Precise Platform ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Places a platform below you that lasts 3 seconds (gives grounded status.)","color":"white"}]

##Air ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Air Ability Cooldown","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Air Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"11.0 seconds","color":"white","bold":true}]
