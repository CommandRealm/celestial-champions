...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Would You Rather ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Gives the user a choice between two randomized items.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Block Smash ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Drops a rideable falling block that does damage.","color":"white"}]
