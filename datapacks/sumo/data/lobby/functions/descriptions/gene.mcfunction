...
tellraw @s {"text":"Gene","bold":true,"color":"#e4e2f5"}
...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"Having ","color":"white","bold":false},{"text":"max knockback","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Full combo meter."}},{"text":" doubles all damage done.","color":"white"}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability ","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":true},{"text":"Spelling Scenario ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Fire projectiles that do damage.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Block Smash ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Drops a falling block that does damage.","color":"white"}]
