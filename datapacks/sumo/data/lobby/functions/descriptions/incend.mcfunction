...
tellraw @s {"translate":"Incend","bold":true,"color":"#802828"}
...
##Passive
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"An ability you don't have to activate/An item unique to the fighter."}}},{"translate":": ","color":"gray","bold":false},{"translate":"One use shield, with a 7.5-second cooldown.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"translate":""},{"translate":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while on the ground."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Boom Doom ","color":"aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Summons a random mob for 7.5 seconds that explodes near players that dropping your item again can recall.","color":"white"}]
...
##Air ability
tellraw @s [{"translate":""},{"translate":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while in the air."}}},{"translate":": ","color":"gray","bold":false},{"translate":"TNT Missile ","color":"dark_aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":" Fire a TNT missile that explodes near players.","color":"white"}]
