##Called to give the description of Incend
...
tellraw @s {"text":"Incend","bold":true,"color":"#802828"}

##Called to give us incend's stats
scoreboard players operation @s calculate = @s fighter
scoreboard players set @s fighter 7
...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"One use shield, with a 7.5-second cooldown.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Boom Doom ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Summons a random mob for 7.5 seconds that explodes near players that dropping your item again can recall.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"TNT Missile ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Fire a TNT missile that explodes near players.","color":"white"}]
