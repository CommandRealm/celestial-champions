...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability ","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":true},{"text":"Adrenaline ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Gain Speed 4 and Jump Boost 6 for 1 second. However, during this ability, knockback is locked to 2.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Star-Strike ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Spikes","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"A downward launch angle."}},{"text":" opponent in front of you.","color":"white"}]
