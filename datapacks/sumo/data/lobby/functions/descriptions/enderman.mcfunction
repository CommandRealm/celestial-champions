...
tellraw @s {"text":"Enderman","bold":true,"color":"#434343"}
...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Time Warp ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Warp yourself to your position three 3 seconds ago.","color":"white"}]

##Ground ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Ground Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"17.5 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Enemy Swap ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Swap positions with a nearby player in front of your face. Sets knockback to 2 for the duration of the ability.","color":"white"}]

##Air ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Air Ability Cooldown","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Air Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"17.5 seconds","color":"white","bold":true}]
