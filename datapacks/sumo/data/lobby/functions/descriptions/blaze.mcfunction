...
tellraw @s {"text":"Blaze","bold":true,"color":"#ffd528"}
...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Homing Heat ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Fire an explosive that track the nearest player.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Fiery Float ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Freezes the user in place and become ","color":"white"},{"text":"invincible","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Immune to knockback."}},{"text":" for 1 second.","color":"white"}]
