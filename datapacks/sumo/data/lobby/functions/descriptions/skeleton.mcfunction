...
tellraw @s {"translate":"Skeleton","bold":true,"color":"#d3d3d3"}
...
##Passive
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"An ability you don't have to activate/An item unique to the fighter."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Bow with arrows on a 4 second cooldown.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"translate":""},{"translate":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while on the ground."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Arrow Barrage ","color":"aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Fire 9 arrows in front of you.","color":"white"}]

##Ground ability cooldown
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"How long until the fighter can use their Ground Ability again."}}},{"translate":": ","color":"gray","bold":false},{"translate":"4.0 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"translate":""},{"translate":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while in the air."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Bone Toss ","color":"dark_aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Toss a ","color":"white"},{"translate":"decoy","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"translate":"Entity capable of receiving knockback."}}},{"translate":" skeleton, gain slow falling and weakness and teleport to the skeleton when it lands.","color":"white"}]
