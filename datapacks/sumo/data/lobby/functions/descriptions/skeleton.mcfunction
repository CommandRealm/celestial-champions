##Called to give the description of Skeleton
...
tellraw @s {"text":"Skeleton","bold":true,"color":"#d3d3d3"}

##Called to give us Skeleton's stats
scoreboard players operation @s calculate = @s fighter
scoreboard players set @s fighter 2
...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"Bow with arrows on a 4 second cooldown.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Arrow Barrage ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Fire 9 arrows in front of you.","color":"white"}]

##Ground ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Ground Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"4.0 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Bone Toss ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Toss a ","color":"white"},{"text":"decoy","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Entity capable of receiving knockback."}},{"text":" skeleton, gain slow falling and weakness and teleport to the skeleton when it lands.","color":"white"}]

##Air ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Air Ability Cooldown","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Air Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"25.0 seconds","color":"white","bold":true}]
