...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability ","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":true},{"text":"Arrow Barrage ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Fire 5 arrows in front of you.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Bone Toss ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Toss a ","color":"white"},{"text":"decoy","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Entity capable of receiving knockback."}},{"text":" skeleton, gain slow falling and weakness and teleport to the skeleton when it lands.","color":"white"}]
