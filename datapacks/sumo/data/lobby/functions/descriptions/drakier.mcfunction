...
tellraw @s {"text":"Drakier","bold":true,"color":"#634d6a"}
...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"A bow that deals extra damage with arrows on a 6-second cooldown. Equipped with an elytra when grounded, unequipped when damaged. Flying too long will break your elytra, this time becomes shorter as your damage increases.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Dragon's Breath ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Dragon's breath ","color":"white"},{"text":"AOE","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Area of effect."}},{"text":" damages opponents in it while raising your combo, lasts 5 seconds.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Firework ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Gives firework.","color":"white"}]

##Air ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Air Ability Cooldown","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Air Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"30.0 seconds","color":"white","bold":true}]
