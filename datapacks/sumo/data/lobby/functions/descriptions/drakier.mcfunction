...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"A bow that deals extra damage with arrows on a 6-second cooldown.. Gain an elytra when grounded, lose the elytra when hit for 1.25 seconds, and if grounded for 5 seconds, obtain a rocket.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability ","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":true},{"text":"Dragon's Breath ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Dragon's breath ","color":"white"},{"text":"AOE","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Area of effect."}},{"text":" damages opponents in it, lasts 5 seconds.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Elytra Repair ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Repairs elytra if lost.","color":"white"}]
