...
tellraw @s {"text":"Slime","bold":true,"color":"#62b64a"}
...
##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability ","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":true},{"text":"Super Leap ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Gain Jump Boost 15 for 2 seconds.","color":"white"}]
...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Slime Trampoline ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Fire a moving ","color":"white"},{"text":"trampoline","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Collisionless bounce-pad."}},{"text":" lasting 5 seconds.","color":"white"}]
