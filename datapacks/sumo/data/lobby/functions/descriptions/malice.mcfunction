...
tellraw @s {"text":"Malice","bold":true,"color":"#515151"}
...
##Passive
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":"An ability you don't have to activate/An item unique to the fighter."}},{"text":": ","color":"gray","bold":false},{"text":"The bow fires an invisible explosive capable of tracking players. You will receive a detonator shortly after shooting.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"text":""},{"text":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while on the ground."}},{"text":": ","color":"gray","bold":false},{"text":"Malicious Strikes ","color":"aqua"},{"text":"- ","color":"gray","bold":false},{"text":"For 5 seconds, any player you attack will be struck with ","color":"white"},{"text":"fear","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"Unable to use abilities."}},{"text":" for 3 seconds."}]

##Ground ability cooldown
tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":""}},{"text":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":"How long until the fighter can use their Ground Ability again."}},{"text":": ","color":"gray","bold":false},{"text":"25.0 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"text":""},{"text":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":false},{"text":"Jetpack Launch ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":"Jetpack, lasts for 6 seconds, canceled by air jumping.","color":"white"}]
