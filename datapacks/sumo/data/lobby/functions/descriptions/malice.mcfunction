##Called to give the description of Malice
tellraw @s [{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"},{"translate":"-","color":"aqua"},{"translate":"=","color":"white"}]
tellraw @s {"translate":"Malice","bold":true,"color":"#515151"}

##Called to give us Malice's stats
scoreboard players operation @s calculate = @s fighter
scoreboard players set @s fighter 15
...
##Passive
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"An ability you don't have to activate/An item unique to the fighter."}}},{"translate":": ","color":"gray","bold":false},{"translate":"The bow fires an invisible explosive capable of tracking players. You will receive a detonator shortly after shooting.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"translate":""},{"translate":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while on the ground."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Malicious Strikes ","color":"aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"For 5 seconds, any player you attack will be struck with ","color":"white"},{"translate":"fear","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"translate":"Unable to use abilities."}}},{"translate":" for 3 seconds."}]

##Ground ability cooldown
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Ground Ability Cooldown","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"How long until the fighter can use their Ground Ability again."}}},{"translate":": ","color":"gray","bold":false},{"translate":"25.0 seconds","color":"white","bold":true}]

##Air ability
tellraw @s [{"translate":""},{"translate":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while in the air."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Jetpack Launch ","color":"dark_aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Jetpack, lasts for 6 seconds, canceled by air jumping.","color":"white"}]

##Air ability cooldown
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Air Ability Cooldown","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"How long until the fighter can use their Air Ability again."}}},{"translate":": ","color":"gray","bold":false},{"translate":"25.0 seconds","color":"white","bold":true}]
