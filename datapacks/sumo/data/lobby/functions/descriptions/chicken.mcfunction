...
##Air ability
tellraw @s [{"text":""},{"text":"Air Ability ","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":"Ability when the fighter drops or offhands their weapons while in the air."}},{"text":": ","color":"gray","bold":true},{"text":"Egg Spike ","color":"dark_aqua"},{"text":"- ","color":"gray","bold":false},{"text":" Shoots an egg below you, ","color":"white"},{"text":"spiking","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":"A downward launch angle."}},{"text":" opponents.","color":"white"}]
