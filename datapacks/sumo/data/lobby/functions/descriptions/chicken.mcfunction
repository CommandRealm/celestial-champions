...
tellraw @s {"translate":"Chicken","bold":true,"color":"#e2e2e2"}
...
##Passive
tellraw @s [{"translate":"","hoverEvent":{"action":"show_text","value":""}},{"translate":"Passive/Loadout","color":"light_purple","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"An ability you don't have to activate/An item unique to the fighter."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Combo weapon swaps to an egg after 5 seconds until thrown, egg does damage.","color":"white","bold":false}]

##Ground ability
tellraw @s [{"translate":""},{"translate":"Ground Ability","color":"aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while on the ground."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Feather Fury ","color":"aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":"Stuns ","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"translate":"Slowness and weakness."}}},{"translate":"opponents in front of the user for one second.","color":"white"}]
...
##Air ability
tellraw @s [{"translate":""},{"translate":"Air Ability","color":"dark_aqua","bold":false,"hoverEvent":{"action":"show_text","value":{"translate":"Ability when the fighter drops or offhands their weapons while in the air."}}},{"translate":": ","color":"gray","bold":false},{"translate":"Egg Spike ","color":"dark_aqua"},{"translate":"- ","color":"gray","bold":false},{"translate":" Shoots an egg below you, ","color":"white"},{"translate":"spiking","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"translate":"A downward launch angle."}}},{"translate":" opponents.","color":"white"}]
