...
execute as @a[tag=!playing,x=0,y=66,z=0,distance=..500,gamemode=adventure] at @s run particle minecraft:happy_villager ~ ~1 ~ 12.5 12.5 12.5 0.25 1 normal @s
...
execute unless entity @a[tag=is_fighter,x=0,y=66,z=0,distance=..500] run kill @e[tag=on_death_timer,x=0,y=66,z=0,distance=..500,tag=!wand_item]
