...
execute if score $kb_hit tutorial matches 3 run item replace entity @e[type=armor_stand,tag=tutorial_knockback] weapon.mainhand with diamond_sword{Enchantments:[{id:"x",lvl:1}]}
