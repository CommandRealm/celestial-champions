...
item replace entity @s enderchest.3 with blue_concrete{clickable:1,invalid_click:1,HideFlags:63,display:{Name:'[{"text":"blockbench.net","bold":true,"italic":false,"color":"yellow"}]',Lore:['[{"text":" - Resource pack modeling","color":"gray","italic":false}]']}}

item replace entity @s enderchest.4 with armor_stand{clickable:1,invalid_click:1,HideFlags:63,display:{Name:'[{"text":"haselkern.com","bold":true,"italic":false,"color":"yellow"}]',Lore:['[{"text":" - Armor stand posing.","color":"gray","italic":false}]']}}

item replace entity @s enderchest.5 with player_head{clickable:1,invalid_click:1,HideFlags:63,display:{Name:'[{"text":"Ds43m","bold":true,"italic":false,"color":"yellow"}]',Lore:['[{"text":" - Animated texture help.","color":"gray","italic":false}]']},SkullOwner:{Id:[I;1807653301,1412319512,-1612626780,28263855],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWRlOGY0ZTMyODI2MjliZGI3NDk3NGI3ODk4YzA2MWUwN2RiOWRhZDg4OWMzMjZjNmI2NmE1MTVjZWU4Nzg1MyJ9fX0="}]}}}
