...
item replace entity @s[scores={prefix=20}] enderchest.11 with name_tag{Enchantments:[{id:"x",lvl:1}],id:1,HideFlags:63,display:{Name:'[{"text":"Exclusive Prefix","color":"white","italic":false,"bold":true}]',Lore:['[{"text":"Selected","color":"blue","italic":false}]']},clickable:1}
...
item replace entity @s[scores={death_animation=12}] enderchest.13 with beacon{Enchantments:[{id:"x",lvl:1}],id:2,HideFlags:63,display:{Name:'[{"text":"Exclusive Death Pose","color":"#ff0000","italic":false,"bold":true}]',Lore:['[{"text":"Selected","color":"blue","italic":false}]']},clickable:1}
...
item replace entity @s[scores={celebration=18}] enderchest.15 with blaze_rod{Enchantments:[{id:"x",lvl:1}],id:3,HideFlags:63,display:{Name:'[{"text":"Exclusive Celebration","color":"aqua","italic":false,"bold":true}]',Lore:['[{"text":"Selected","color":"blue","italic":false}]']},clickable:1}
