...
##Middle bar
replaceitem entity @s enderchest.4 light_gray_stained_glass{clickable:1,invalid_click:1,HideFlags:63,display:{Name:'[{"text":""}]'}}

replaceitem entity @s enderchest.13 player_head{CustomModelData:1,clickable:1,random:1,HideFlags:63,display:{Name:'[{"text":"R","color":"#ff0000","bold":true,"italic":false},{"text":"A","color":"#ff7f00","bold":true},{"text":"N","color":"#ffff00","bold":true},{"text":"D","color":"#00FF00","bold":true},{"text":"O","color":"#0000ff","bold":true},{"text":"M","color":"#8b00ff","bold":true}]',Lore:['[{"text":"Click to select random.","color":"gray","italic":false}]','[{"text":"Your fighter will be randomized","color":"gray","italic":false}]','[{"text":"at the start of every game.","color":"gray","italic":false}]']},SkullOwner:{Id:[I;682268746,544686284,-1914182079,-1376598889],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDZiYTYzMzQ0ZjQ5ZGQxYzRmNTQ4OGU5MjZiZjNkOWUyYjI5OTE2YTZjNTBkNjEwYmI0MGE1MjczZGM4YzgyIn19fQ=="}]}}}

replaceitem entity @s[tag=random_fighter] enderchest.13 player_head{invalid_click:1,Enchantments:[{id:"minecraft:placeholder",lvl:1}],random:1,CustomModelData:1,clickable:1,HideFlags:63,display:{Name:'[{"text":"R","color":"#ff0000","bold":true,"italic":false},{"text":"A","color":"#ff7f00","bold":true},{"text":"N","color":"#ffff00","bold":true},{"text":"D","color":"#00FF00","bold":true},{"text":"O","color":"#0000ff","bold":true},{"text":"M","color":"#8b00ff","bold":true}]',Lore:['[{"text":"SELECTED","color":"dark_aqua","italic":false,"bold":true}]','[{"text":"Your fighter will be randomized","color":"gray","italic":false}]','[{"text":"at the start of every game.","color":"gray","italic":false}]']},SkullOwner:{Id:[I;-407951598,-1659548948,-1135620899,-231188373],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzM1YmEzOTNiODYxMGI2M2ViZWU0YzEzYzgzNThiYzZjOTRhOWRlZGM4ZTRkN2QzNmI5MjIyNTdlNjVlOCJ9fX0="}]}}}

replaceitem entity @s enderchest.22 light_gray_stained_glass{clickable:1,invalid_click:1,HideFlags:63,display:{Name:'[{"text":""}]'}}
