...
execute if score $buddy training_area matches 0 run replaceitem entity @e[type=skeleton,tag=training_buddy,limit=1] weapon.mainhand red_dye{CustomModelData:1,Enchantments:[{id:"minecraft:knockback",lvl:5}]}
execute if score $buddy training_area matches 1 run replaceitem entity @e[type=skeleton,tag=training_buddy,limit=1] weapon.mainhand black_dye{CustomModelData:1}
execute if score $buddy training_area matches 2 run replaceitem entity @e[type=skeleton,tag=training_buddy,limit=1] weapon.mainhand air
